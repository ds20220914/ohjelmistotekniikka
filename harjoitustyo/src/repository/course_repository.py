...
class CourseRepository:
    ...
    '''palauttaa kaikkien kurssisuorituksien tiedot
       Returns:
           palauttaa jokaisen kurssisuorituksen kurssinimi,opintopiste ja arvosana tupleina listassa
    '''
        db_connection = self._connection2.cursor()
    ...
    '''palauttaa kaikkien kurssisuorituksien tiedot opiskelijanumeron perusteella
       Returns:
           palauttaa opiskelijanumeron perusteella jokaisen kurssisuorituksen kurssinimi,opintopiste ja arvosana tupleina listassa
    '''
        db_connection = self._connection2.cursor()
