...
class TeacherView1:
	...
	def _initialize(self):
		...
		if self.oikea==False:
			course_label=ttk.Label(master=self._frame,text="No course added")
			course_label.grid(row=1, column=0,sticky=(constants.E, constants.W))
		...
		if self.oikea==True:
			...
			for i in range(len(array1)):
				...
				course_label.grid(row=i+1, column=0,sticky=(constants.E, constants.W))
