...
class NewCourseView:
	...
	def _initialize(self):
		...
		rolenumber_label=ttk.Label(master=self._frame,text=" student rolenumber")
		...
		add= ttk.Button(master=self._frame, text="Add course performance",command=self.check_course)
		...
		course_name_label.grid(row=2, column=0,sticky=(constants.E, constants.W))
		self.course_name_entry.grid(row=2, column=1,sticky=(constants.E, constants.W))
		grade_label.grid(row=3, column=0,sticky=(constants.E, constants.W))
		self.grade_entry.grid(row=3, column=1,sticky=(constants.E, constants.W))
		credit_label.grid(row=4, column=0,sticky=(constants.E, constants.W))
		self.credit_entry.grid(row=4, column=1,sticky=(constants.E, constants.W))
		add.grid(row=5, column=0, columnspan=2,sticky=(constants.E, constants.W))
